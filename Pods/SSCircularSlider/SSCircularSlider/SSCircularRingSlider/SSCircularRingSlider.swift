...
public protocol SSCircularRingSliderDelegate {
    func controlValueUpdated(value: Int,slider:SSCircularRingSlider)
}

public class SSCircularRingSlider: UIView {
    ...
    public var delegate: SSCircularRingSliderDelegate?
    ...
    fileprivate func updateValues() {
        ...
        updateValueOfLabel()
        delegate?.controlValueUpdated(value: arrLabelValues[currentIndex],slider: self)
    }
